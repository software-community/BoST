...
export function UpdateCourseBtn({ id }) {
  return (
    <Link href={`/dashboard/courses/${id}/edit`} className="mr-1">
      <svg
...
export function DeleteCourseBtn({ id }) {
  const deletebyId = deleteCourse.bind(null, id);
  return (
