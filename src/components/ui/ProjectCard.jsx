...
const ProjectCard = ({
  ...
  return (
    <div className="text-black bg-gray-200 w-72 lg:w-[350px] py-12   shadow-white px-4 lg:px-6 rounded-lg flex flex-col flex-none justify-center items-center transform transition-all hover:scale-105">
